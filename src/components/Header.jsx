  ...
  render(){
    return (
      ...
      <ThemeContext.Consumer>
        ...
        return(
          <header className='border h-[70px] sm:h-[80px] lg:h-[100px] xl:h-[120px] flex justify-between items-center px-2 lg:px-10' style={{background: theme.bg, color:theme.txt}}>
